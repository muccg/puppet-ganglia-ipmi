...
# grabbed from https://github.com/ganglia/gmetric/blob/master/health/ipmi_temp/ipmi_temp.sh
# and modified a little bit by Grahame
...
ipmitool sdr type Temperature |
  ...
  while IFS='|' read name value; do
      ...
      gmetric -x 300 -g ipmi -n ${name// /_} -v $value -t float -u Celsius "$@"
  done
